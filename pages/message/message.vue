    ...
    <div class="message-content-con">
      <transition name="view-message">
        <div v-if="showMesTitleList" class="message-title-list-con">
          <Table ref="messageList" :columns="mesTitleColumns" :data="currentMesList" :no-data-text="noDataText"
                 size="small"></Table>
        </div>
      </transition>
    ...
    methods: {
      ...
      getContent(index) {
        ...
        switch (this.currentMessageType + index) {
          case 'unread0':
            mesContent = '这是您点击的《欢迎登录采购后台管理系统，来了解他的用途吧》的相关内容。';
            break;
          case 'unread1':
            mesContent = '这是您点击的《使用采购后台系统吧》的相关内容。';
            break;
          case 'unread2':
            mesContent = '这是您点击的相关内容。';
            break;
          case 'hasread0':
