    ...
    <div>
      ...
      <Form ref="formValidate" label-position="left" :label-width="80">
        <Row style="padding-bottom:30px">
          ...
          <Col span="6">
            <FormItem label="直属上级：" :label-width="75">
              <Input
                style="max-width: 200px"
                readonly
        ...
        <Row style="padding-bottom:30px">
          <Col span="6">
            <FormItem label="合作商名称：" :label-width="95">
              <Input
                style="max-width: 200px"
                readonly
      ...
      <Row style="padding-bottom:30px">
        <Form ref="formValidate" label-position="left" :label-width="70">
          <FormItem label="签到地址:">
            <Input
              readonly
      ...
      <Row style="padding-bottom:30px">
        <Form ref="formValidate" label-position="left" :label-width="40">
          <FormItem label="备注:">
      ...
      <Form ref="formValidate" label-position="left" :label-width="80">
        <Row style="padding-bottom:30px">
          ...
          <Col span="6">
            <FormItem label="活动类型:" :label-width="80">
              ...
              <Input
                style="max-width: 200px"
                readonly
                v-model="editList.saleInfo.activity_type"
              />
            </FormItem>
          </Col>
          <Col span="6">
            <FormItem label="活动人数:" :label-width="80">
              <Input
                style="max-width: 200px"
                readonly
          ...
          <Col span="24">
            <FormItem label="同行人员：" :label-width="80">
              <Input
                readonly
      ...
      <Row style="padding-bottom:30px">
        <Form ref="formValidate" label-position="left" :label-width="80">
          <FormItem label="活动销售目标：" :label-width="100">
      ...
      <Form ref="formValidate" label-position="left" :label-width="100">
        <Row style="padding-bottom:30px">
          <Col span="8">
            <FormItem label="活动进行天数:">
              <!-- 未找到对应字段 -->
              <Input
                readonly
                style="max-width: 200px"
                v-model="editList.saleInfo.days"
              ></Input>
            </FormItem>
          </Col>
          <Col span="8">
            <FormItem label="当天销售达成（当天总业绩）:" :label-width="180">
              <Input
                readonly
                style="max-width: 200px"
          ...
          <Col span="8">
            <FormItem label="活动累计销售达成：" :label-width="120">
              <!-- 未找到相关字段 -->
              <Input
                readonly
                style="max-width: 200px"
                v-model="editList.saleInfo.activity_sales_achieved"
              ></Input>
            </FormItem>
          </Col>
        </Row>
        <Row style="padding-bottom:30px">
          <Col span="8">
            <FormItem label="个人当天销售达成（业绩）：" :label-width="170">
              <Input
                readonly
                style="max-width: 200px"
